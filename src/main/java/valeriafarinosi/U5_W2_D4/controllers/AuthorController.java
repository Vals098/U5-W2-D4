...
public class AuthorController {
    ...
    public AuthorResponseDTO createAuthor(@RequestBody AuthorRequestDTO payload) {
    ...
    @PutMapping("/{authorId}")
    public BlogAuthor findByIdAndUpdate(@PathVariable int authorId, @RequestBody AuthorRequestDTO payload) {
